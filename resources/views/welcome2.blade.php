            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="/images/slider.jpg" alt="First slide" style="height: 671px">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/images/slider_2.jpg" alt="Second slide" style="height: 671px">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="/images/slider_3.jpg" alt="Third slide" style="height: 671px">
                    </div>
                </div>
